    ...
    return (
        <>
            ...
            <section className="lg:px-50 md:px-25 sm:px-10 px-0 py-10 md:pt-10 pt-32 flex flex-col items-start justify-center" id="home">
                <h1 className="2xl:text-display md:text-heading1 text-heading2 text-black font-bold tracking-tight self-start md:text-left text-center w-full leading-10 xs:leading-normal pb-5 xs:pb-0">Au Fil d'Elbeuf</h1>
            ...
            <section className="lg:px-50 md:px-25 px-10 py-10 md:pt-10 pt-32 flex flex-col items-start justify-center gap-5" id="mise-en-place">
                ...
                <div className="flex flex-col md:flex-row gap-1.5 md:gap-5 items-center justify-center md:items-end-safe md:justify-center w-full my-10 *:md:grow-1 *:md:shrink-1 *:md:basis-0 *:text-center">
            ...
            <section className="lg:px-50 md:px-25 px-10 py-10 md:pt-10 pt-32 flex flex-col items-start justify-center" id="bilan">
