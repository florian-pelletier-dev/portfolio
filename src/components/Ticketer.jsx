    ...
    return (
        <>
            ...
            <section className="lg:px-50 md:px-25 px-10 py-10 md:pt-10 pt-32 flex flex-col items-center justify-center" id="home">
                <h1 className="2xl:text-display text-heading1 text-black font-bold tracking-tight self-start md:text-left text-center w-full">Ticketer</h1>
            ...
            <section className="lg:px-50 md:px-25 px-10 py-21 flex flex-col items-start justify-center" id="mise-en-place">
                ...
                <p className="lg:w-2/3 md:w-3/4 w-full text-balance">Pour pouvoir réserver les évènements, j'ai choisi un format de cartes avec image, texte, et CTA sur la page d'accueil menant aux pages de l'évènement en question</p>
                ...
                <p className="lg:w-2/3 md:w-3/4 w-full text-balance">Enfin, en liant chaque carte à l'id de son administrateur, chacun peut créer ses évènements et les modifier, avec toutes les informations nécessaires.</p>
                <img src={ticketer_modify} alt="" className="rounded-xl md:w-2/3 w-full p-10 mb-10 mx-auto" />
            </section>
            <section className="lg:px-50 md:px-25 px-10 py-21 flex flex-col items-start justify-center" id="conclusion">
