    ...
    return (
        <>
            ...
            <section className="lg:px-50 md:px-25 sm:px-10 px-0 py-10 md:pt-10 pt-32 flex flex-col items-center justify-center" id="home">
                <h1 className="2xl:text-display md:text-heading1 text-heading2 text-black font-bold tracking-tight self-start md:text-left text-center w-full">Ticketer</h1>
            ...
            <section className="lg:px-50 md:px-25 sm:px-10 px-0 py-21 flex flex-col items-start justify-center" id="mise-en-place">
                ...
                <p className="px-10 sm:px-0 lg:w-2/3 md:w-3/4 w-full text-balance">Pour pouvoir réserver les évènements, j'ai choisi un format de cartes avec image, texte, et CTA sur la page d'accueil menant aux pages de l'évènement en question</p>
                <div className="flex flex-col gap-5 w-full items-center justify-center md:p-10 py-10 mb-10">
                ...
                <p className="px-10 sm:px-0 lg:w-2/3 md:w-3/4 w-full text-balance">J'ai ensuite créer le système de connexion et de création de compte. Pour s'inscrire, la personne aura besoin de son nom d'utilisateur, de son email (unique) et d'un mot de passe. Afin d'activer le compte, un code OTP (One-Time-Password) sera envoyé à l'email fourni.</p>
                <div className="flex flex-col sm:flex-row gap-5 w-full items-center justify-center md:p-10 py-10 mb-10">
                    <img src={ticketer_signin} alt="la page du premier évènement" className="w-2/3 sm:w-1/3 rounded-xl object-contain" />
                    <img src={ticketer_otp} alt="la page du premier évènement" className="w-2/3 sm:w-1/3 rounded-xl object-contain" />
                    <img src={ticketer_login} alt="deux cartes différentes d'évènements" className="w-2/3 sm:w-1/3 rounded-xl object-contain" />
                </div>
                <p className="px-10 sm:px-0 lg:w-2/3 md:w-3/4 w-full text-balance">Enfin, en liant chaque carte à l'id de son administrateur, chacun peut créer ses évènements et les modifier, avec toutes les informations nécessaires.</p>
                <img src={ticketer_modify} alt="" className="rounded-xl md:w-2/3 w-full p-10 mb-10 mx-auto" />
            </section>
