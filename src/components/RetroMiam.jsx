    ...
    return (
        <>
            ...
            <section className="lg:px-50 md:px-25 px-10 py-10 md:pt-10 pt-32 flex flex-col items-center justify-center" id="home">
                <h1 className="2xl:text-display text-heading1 text-black font-bold tracking-tight self-start md:text-left text-center w-full">Retro'miam</h1>
            ...
            <section className="lg:px-50 md:px-25 px-10 py-21 flex flex-col items-start justify-center" id="mise-en-place">
                ...
                <p className="lg:w-2/3 md:w-3/4 w-full text-balance">Afin de partir sur de bonnes bases, le principal fut de créer un wireframe pour le site. Ayant d'abord produit celui-ci sur papier, j'ai ensuite pu le calquer en une version moyenne-fidélité sur l'ordinateur.</p>
                ...
                <p className="lg:w-2/3 md:w-3/4 w-full text-balance">J'ai également créé le diagramme d'arbre logique pour la page d'accueil, permettant de connaître exactement les différents mouvements intra-pages et externes de celle-ci. </p>
                <img src={retro_diagram} alt="" className="rounded-xl w-2/3 p-10 mx-auto pb-0" />
            </section>
